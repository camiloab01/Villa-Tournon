...
(function() {
	...
	app.config(['$routeProvider',
	  function($routeProvider) {
	      ...
	      $routeProvider.when('/el-hotel', {
	        templateUrl: '/el-hotel.html',
	      });
	      ...
	      $routeProvider.when('/room-preview-deluxe', {
	        templateUrl: '/room-preview-deluxe.html',
	      });
	      $routeProvider.when('/room-preview-standard', {
	        templateUrl: '/room-preview-standard.html',
	      });
	      $routeProvider.when('/room-preview-superior', {
	        templateUrl: '/room-preview-superior.html',
	      });
	...
	var LanguageController = function($scope, $location, localStorageService){ 
		...
		$scope.slides = [
			{
				image: 'img/home_page/big_slider/DSC_2481.jpg',
				caption: 'Hotel Villa Tournon',
				caption2: 'Visit Us',
				caption3: 'You are Welcome',
				link: '/el-hotel'
			},
			{
				image: 'img/home_page/big_slider/DSC_2097.jpg',
				caption: 'Test',
				caption2: 'Test Us',
				caption3: 'You are Test'
			},
			{
				image: 'img/home_page/big_slider/DSC_2286.jpg',
				caption: 'Ricón Azul',
				caption2: 'Come and enjoy our new restaurant',
				caption3: 'You are Welcome'
			},
			{
				image: 'img/home_page/big_slider/DSC_2398.jpg',
				caption: 'Ebony and Ivory',
				caption2: 'Come and enjoy our new restaurant',
				caption3: 'You are Welcome'
			},
			{
				image: 'img/home_page/big_slider/DSC_1979.jpg',
				caption: 'Pool and Jacuzzi',
				caption3: 'With us you will enjoy your Vacation'
			},
			{
				image: 'img/home_page/big_slider/DSC_2494.jpg',
		...
		$scope.LeslieYears = $scope.CurrentYear - 1945;
		 ...
		 if(spanish === 'true'){
			 ...
			 $scope.CheckIn = "Entrada";
			 $scope.CheckOut = "Salida";
			 $scope.PricesFrom = "Precios desde";
			 $scope.ChangeSched = "La salida podría ser más tarde dependiendo de la disponibilidad";
			 $scope.Write = "Escribir";
			...
			$scope.Hotel1="Hotel Villa Tournon  tiene 80 habitaciones entre  Estándar, Superior y De Luxe. Algunas de la habitaciones se destacan por su vista hacia un amplio jardín rodeando la piscina y jacuzzi; además de una hermosa vista de San José especialmente de noche, con sus edificios iluminados, incrustados en una loma como compitiendo entre ellos para superar en altura.";
			$scope.Hotel2="Está situado en la exclusiva área ejecutiva de Barrio Tournon, a solo ocho cuadras de la avenida central de San José; la capital de Costa Rica. A escasos pasos se ubica una importante universidad privada, instituciones relevantes del estado, centros comerciales, centros ejecutivos, terminal de transporte hacia la zona del Caribe, el Parque Simón Bolívar, Jardín de mariposas y otros lugares de interés.";
			$scope.Hotel3="El hotel, construido a principio de los años 80 sobre un terreno irregular en terraza; consta de tres pisos. Se ingresa por el tercer piso para trasladarse a la segunda y la primera planta. Continuando el descenso se llega al área de la piscina y jacuzzi rodeado de un hermoso y colorido jardín.";
			...
			$scope.Hotel5="Todas las áreas del Hotel están engalanadas con pinturas de diferentes temáticas y técnicas, de autores  costarricenses y extranjeros; los cuales convierten este hotel en una auténtica  Galería. El arte y la cultura son su emblema. La congregación de estas obras de arte acompañado del amable servicio del personal es una invitación para conocer más de Costa Rica.";
			$scope.PlacesVisit="Lugares que puede recorrer caminando:";
			$scope.About1="Soy Leslie Wilson Shimpson, Gerente General del Hotel Villa Tournon, Costarricense de nacimiento. Comencé a trabajar en  hotelería a la edad de 21 años en 1966, como camarero. ";
			$scope.About2="Oportunidad de trabajo en Costa Rica no era fácil entonces; por tal motivo empecé a ofrecer mis servicios para trabajar gratuitamente con la firme convicción de que en poco tiempo, el lugar de trabajo me ofrecería pagar un salario; mas los lugares que visité; supongo  que tuvieron duda de mi buena fe.";
			$scope.About3="En menos de dos años trabajando como camarero y en otros puestos me escale al puesto de asistente del Gerente del hotel; meses antes de completar  cuatro años de trabajar en la empresa, mi jefe y yo nos convertimos en socios en un nuevo hotel. Transcurridos  dos años adquirí su participación y me convertí  en el único propietario. Durante ese período no había completado la escuela secundaria.";
			$scope.About4="En la actualidad soy abogado y también fui a la escuela de periodismo.";
			$scope.About5="Fundé Hotel Villa Tournon en 1992.Cuarenta y nueve años han transcurrido desde que empecé a trabajar en hotelería. Tengo una gran pasión por mi trabajo, me encanta tratar con la gente de todas las nacionalidades. Mi misión es transmitir a una nueva generación en hospitalidad la satisfacción que se experimenta apoyando a extraños todos los días."
			...
			$scope.PerfectArmonyDescription="Un espacio para los dos donde la sensorialidad del restaurante le seduce en una perfecta armonía.";
			 ...
			 $scope.PricesFrom = "Prices from";
		 	 $scope.PhotoGallery = "Photo Gallery";
		 	 $scope.ChangeSched = "Late check-out could be possible upon availability";
			...
			$scope.Hotel1="Hotel Villa Tournon has 80 rooms including standard, Superior and De Luxe rooms. Some of the rooms stand out for their view to a garden surrounding the pool and Jacuzzi; In addition to a beautiful view of San Jose at night, with its illuminated buildings, embedded in a Hill as competing with each other to exceed in height. ";
			$scope.Hotel2="This hotel is situated in the exclusive executive area of Barrio Tournon, just eight blocks from the central avenue of San Jose; the capital of Costa Rica. A few steps away are located: relevant institutions of the State, a major private university, shopping malls, Executive Offices, transportation terminal that goes to the Caribbean coast of Costa Rica, Simon Bolívar Park,   Butterfly Garden and other attractions are located.";
			$scope.Hotel3="The hotel, built in the early '80s on uneven ground; it consists of three floors. You enter through the third floor to move to the second and first floor. Continuing the descent reach the area of ​​the pool and Jacuzzi surrounded by a beautiful and colorful garden. ";
			$scope.Hotel4="In the architectural structure of this building you will appreciate a stunning sky craft, made with fine and precious wood in the Lobby, Bar and the Restaurant Rincon Azul. Also the floors of most of the rooms are furnished with the mention wood. At present logging and selling are banned by law in our country.";
			$scope.Hotel5="All areas of the hotel are adorned with paintings of different themes and techniques of local and foreign authors; which makes this hotel a real gallery. Art and culture is its emblem. The congregation of these works of art accompanied by friendly service staff is an invitation to learn more about Costa Rica.";
			$scope.PlacesVisit="Places you can visit in walking distance:";
			$scope.About1="I am Leslie Wilson Shimpson, General Manager of Hotel Villa Tournon, Costa Rican by birth. I started working in hospitality at the age of 21 in 1966 as a waiter ";
			$scope.About2="Job opportunities in Costa Rica was not easy then; Therefore I began to offer my services to work for free with the firm conviction that in time, the workplace would offer to pay me a salary; but the places I visited; I guess they had doubt my good faith.";
			$scope.About3="In less than two years working as a waiter and in other post I got to the position of assistant manager of the hotel; months before completing four years of work in the company, my boss and I become partners in a new hotel. After two years I acquired if share and became the sole owner. During that period I had not completed high school.";
			$scope.About4="Today I am a lawyer and also went to journalism school.";
			$scope.About5="Hotel Villa Tournon I founded in 1992. Forty-nine years have passed since I start working in hospitality. I have a great passion for my job, I love dealing with people of all nationalities. My mission is to convey to a new generation of hospitality workers the satisfaction which can be experienced assisting strangers every day.";
			$scope.About7="Thanks for your visit; I hope you enjoy our web site";
			$scope.AboutUs="About Us";
			$scope.ContactUs="Contact Us";
			$scope.DropLine="Drop us a line";
			$scope.Message="Message";
			$scope.Name="Name";
			$scope.EbonyDescription="Ebony & Ivory restaurant is a space recently designed in the hotel consisting of a modern and warm environment; where you can distinguish the decoration in black and white, in the ceilings, walls, furniture and tableware; additionally supplemented with arts including paintings, photographs and sculptures. The cuisine also shares this dichotomy. You will be able to enjoy a dish fusion regarding European food mainly Spanish, French, and Italian likewise in one sense, and on the other, the cuisine of the Caribbean countries. The Caribbean representing the concept of Ebony and the european of  Ivory.";
			...
			$scope.EventsDesciption="The hotel offers the possibility of holding various events with a differentiated service where premium attitude is displayed. There are two rooms enabled “La Jungla”  and  “Rincón Azul” with capacity of 45 and 150 people respectively, are enabled and equipped with materials and equipment needs, suitable for events such as conferences, seminars, weddings, baby showers, graduation party, lunches and private dinners; Likewise, enjoy our services of coffee break and the range of cuisine that we offer you in format menu, buffet or cocktail. ";
